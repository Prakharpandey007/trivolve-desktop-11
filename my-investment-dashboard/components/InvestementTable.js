      ...
      <table className="w-full text-sm text-left text-gray-300 border border-gray-700 rounded-lg">
        <thead className="text-xs uppercase bg-gray-800 text-gray-400 rounded-lg">
          <tr>
            ...
            <th scope="col" className="px-6 py-3">INDICATIVE AMOUNT</th>
            <th scope="col" className="px-6 py-3">INVESTMENT AMOUNT</th>
            <th scope="col" className="px-6 py-3">EFFECTIVE INVESTMENT DATE</th>
        ...
        <tbody>
          {hasData ? (
            ...
            <tr className="border-b bg-gray-800 border-gray-700">
              ...
              <td className="px-6 py-4">Example Deal</td>
              <td className="px-6 py-4">$10,000</td>
              <td className="px-6 py-4">$9,500</td>
